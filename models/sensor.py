...
class Sensor:
  ...
  def __str__(self):
    return (
      f"Sensor(sensor_id={self.sensor_id}, original_id='{self.original_id}', "
      f"sensor_type='{self.sensor_type}', source='{self.source}', "
      f"position={self.position}, additional_information='{self.additional_information}')"
    )
